...
/*@argument
  ...
  @description translate value from
*/
uniform mediump vec2 elipsePos3;
...
void main(void)
{
    ...
    highp vec4 vertexCoord2 = vec4(
                ...
                0.0,
                1.0);
    highp vec4 vertexCoord3 = vec4(
                vertexArg.x/vertexArg.w - elipsePos3.x * rectSize.x,
                vertexArg.y/vertexArg.w - elipsePos3.y * rectSize.y,
                0.0,
                1.0);
    ...
    mediump float posLength3 = length(vertexCoord3);
    v_t.z = -(posLength3 - x)/(szl*slope1);
