...
#include "../MastactvaModels/drawingdata_effect.h"
#include <QDir>
#include <memory>
...
{
    m_filesource = std::make_shared<MapFileSource>();
}
...
void ImageDataInitializer::initialize(drawing_data::QuizImageObjects &data_, int argsSetIndex_) const
{
...
std::pair<const char *, const char *> ImageDataInitializer::getDescription() const
{
